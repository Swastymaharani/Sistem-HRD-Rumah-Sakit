...
class Pegawai extends Model
{
    ...
    'status_pegawai_id','jenis_profesi_id', 'spesialisasi_id','sub_spesialisasi_id','qualifikasi_id','pendidikan_terakhir_id',
    'pendidikan_terakhir_id', 'jabatan_fungsional_terakhir', 'jabatan_fungsional_terakhir','jabatan_struktural_id','unit_id',
